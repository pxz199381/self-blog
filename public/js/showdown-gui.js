...
function startGui() {
    ...
    window.onkeydown = function(e){
        ...
        if(e.target.id == 'inputPane'){
            ...
            /*if(e.keyCode == 9){
                e.preventDefault();
                var start = inputPane.selectionStart,
                    end = inputPane.selectionEnd;
                inputPane.value = inputPane.value.substring(0,start)
                    + '\t'+inputPane.value.substring(end);
                inputPane.selectionStart = inputPane.selectionEnd = start + 1;
            }*/
        }
    }
